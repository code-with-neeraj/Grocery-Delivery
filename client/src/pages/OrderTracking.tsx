      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-app-text-light mt-1">Placed on {new Date(order!.createdAt).toLocaleDateString("en-In", {month: "long", day: "numeric", year:"numeric" })}</p>
          </div>
            ...
            <div className="bg-white rounded-2xl p-5">
              ...
              <div className="mt-4 pt-3 border-t border-app-border space-y-1.5 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-app-text-light">Subtoatal</span>
