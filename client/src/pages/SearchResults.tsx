...
const SearchResults = () => {
  ...
  const filteredProducts = dummyProducts.filter((p: any) =>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-sm text-app-text-light mb-6 max-w-md mx-auto">We couldn't find any products matching "{query}". Try a defferent search term.</p>
