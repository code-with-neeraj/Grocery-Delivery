            ...
            {!isLoginState && (
             ...
             <label className="text-sm flex flex-col gap-1">
                ...
                <div className='relative'>
                  ...
                  <input type='email' value={email} onChange={(e) =>setEmail(e.target.value)} required placeholder='your@example.com' className='w-full pl-11 pr-4 py-3 text-sm bg-white rounded-xl border not-focus:border-app-border transition-all'/>
                </div>
              </label>
               <label className="text-sm flex flex-col gap-1">
                Password
              ...
              <button type='submit' disabled={loading} className='flex-center w-full py-3 bg-green-950 text-white font-semibold rounded-xl hover:bg-gray-900 transition-colors disabled:opacity-50'>
